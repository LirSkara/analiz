...
<body>
    ...
    <!-- ======= Header ======= -->
    <header id="header" class="fixed-top c-bg pb-0">
        <div class="container d-flex align-items-center mb-3">

            <h1 class="logo me-auto"><a href="/">Labsi.clinik</a></h1>

            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    <li class="ps-0"><a class="nav-link scrollto active" href="#hero">ГЛАВНАЯ</a></li>
                    <li><a class="nav-link scrollto" href="#about">СДАТЬ АНАЛИЗЫ</a></li>
                    <li><a class="nav-link scrollto" href="#services">ВЫЕЗД НА ДОМ</a></li>
                    <li><a class="nav-link scrollto" href="#departments">СКИДКИ И АКЦИИ</a></li>
                    <li class="dropdown me-4"><a href="#"><span>СЕРВИСЫ</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                    ...
                    <a class="text-white border-bottom-0 appointment-btn fs-6 py-2 px-4 bg-success" href="#doctors">Получить результат</a>
                </ul>
                <i class="bi bi-list mobile-nav-toggle"></i>
            </nav><!-- .navbar -->

            <a href="#appointment" class="appointment-btn scrollto fs-6"><i class="bi bi-person-fill"></i> Личный кабинет</a>
